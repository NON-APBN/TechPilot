...
import '../models/gadget.dart'; // Impor model Gadget
      ...
      children: [
        ...
        Expanded(
          child: BlocBuilder<GadgetBrowserCubit, GadgetBrowserState>(
            builder: (context, state) {
              if (state.items.isEmpty && state.q.isNotEmpty) {
                return const Center(child: Text('Tidak ada gadget yang cocok.'));
              }
